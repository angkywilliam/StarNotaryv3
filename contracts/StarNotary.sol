...
contract StarNotary is ERC721 {
    ...
    //TODO think better way to implement this with safeTransferFrom
    ...
    function buyStar(uint256 _tokenId) public payable {
        ...
        if(msg.value > starCost) {
            ...
            spender.transfer(msg.value - starCost);
        }
    }
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        //1. You should return the Star saved in tokenIdToStarInfo mapping
         Star memory reterievedStar = tokenIdToStarInfo[_tokenId];
         return reterievedStar.name;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerAddress1 || msg.sender == ownerAddress2, "Operation need to be performed by owner");
